...
<div class="card text-dark bg-light m-3 ">
    ...
    <div class="card-footer">
        <form method="post" action="cart-insert?product_id=<?php echo e($product['id']) ?>">
            <div class="row">
                <div class="col">
                    <div class="input-group mb-3">
                        <span class="input-group-text">Aktueller Stückpreis: <?php echo e($product['price']) ?> €</span>
                        <input type="text" class="form-control" name="amount">
                        <span class="input-group-text">Stück</span>
                    </div>
                </div>
                <div class="col-2">
                    <input type="submit" class="btn btn-success" value="In den Einkaufswagen">
                </div>
            </div>
